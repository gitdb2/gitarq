...
public final class LectorDeConfiguracion {
     ...
     * en caso de no encontrarse la clave, se retorna la misma
     * @param clave
     * @return
     */
    ...
    /**
     * * metodo para acceder a los valores del properties por medio de la
     * clave. se pasa un valor por defecto que en caso de no encontrarse la
     * propiedad se retorna dicho valor.
     *
     * @param clave
