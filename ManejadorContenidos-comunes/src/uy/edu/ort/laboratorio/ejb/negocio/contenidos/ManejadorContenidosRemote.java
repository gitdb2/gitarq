...
public interface ManejadorContenidosRemote {
     ...
     * @throws ArquitecturaException
     */
    public long modificarContenidoEntradaBlog(long idEntradaBlog,
            String titulo, String nombreAutor, Date fechaPublicacion,
            String texto, List<String> tags) throws ArquitecturaException;
     ...
     * @throws ArquitecturaException
     */
    public boolean eliminarEntradaBlog(long idEntradaBlog)
            throws ArquitecturaException;
     ...
     * @throws ArquitecturaException
     */
    public boolean eliminarPaginaWeb(long idPaginaWeb)
            throws ArquitecturaException;
